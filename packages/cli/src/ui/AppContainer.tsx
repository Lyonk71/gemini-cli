...
import { type HistoryItem, ToolCallStatus, type HistoryItemWithoutId } from './types.js';
...
export const AppContainer = (props: AppContainerProps) => {
  ...
  }, [buffer, userMessages, getQueuedMessagesText, clearQueue, pendingHistoryItems]);
  ...
  const handleGlobalKeypress = useCallback(
    (key: Key) => {
      ...
      const anyDialogOpen = isThemeDialogOpen || isAuthDialogOpen || isEditorDialogOpen || 
                            isSettingsDialogOpen || isFolderTrustDialogOpen || 
                            isAuthenticating || showPrivacyNotice;
      if (anyDialogOpen) {
        return;
      }
